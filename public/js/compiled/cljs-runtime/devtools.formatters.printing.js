...
var len__4789__auto___27924 = arguments.length;
var i__4790__auto___27925 = (0);
while(true){
if((i__4790__auto___27925 < len__4789__auto___27924)){
args__4795__auto__.push((arguments[i__4790__auto___27925]));

var G__27926 = (i__4790__auto___27925 + (1));
i__4790__auto___27925 = G__27926;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27822){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27823,G__27824,seq27822__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27855_SHARP_){
return (!((cljs.core.meta(p1__27855_SHARP_) == null)));
})))){
...
var map__27876 = opts;
var map__27876__$1 = (((((!((map__27876 == null))))?(((((map__27876.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27876.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27876):map__27876);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27876__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27884){var _e__26733__auto__ = e27884;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e27887){var _e__26733__auto__ = e27887;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__27903 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27904 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27904);

try{var map__27906 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27906__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27903);
}});
...
var temp__5733__auto___27958 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___27958)){
var managed_print_level_27959 = temp__5733__auto___27958;
var _STAR_print_level_STAR__orig_val__27915_27960 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27916_27961 = managed_print_level_27959;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27916_27961);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__27913_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__27913_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27915_27960);
}} else {
job_fn();
}
