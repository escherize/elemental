...
return ((cljs.tools.reader.impl.utils.numeric_QMARK_(initch)) || (((((("+" === initch)) || (("-" === initch)))) && (cljs.tools.reader.impl.utils.numeric_QMARK_(cljs.tools.reader.reader_types.peek_char(reader))))));
});
/**
...
var G__30786 = cljs.tools.reader.reader_types.read_char(rdr);
ch = G__30786;
continue;
} else {
return ch;
...
while(true){
if(cljs.tools.reader.impl.utils.newline_QMARK_(cljs.tools.reader.reader_types.read_char(reader))){
} else {
continue;
}
break;
...
var vec__30757 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30757,(0),null);
return (match === s);
});
...
var len__4789__auto___30824 = arguments.length;
var i__4790__auto___30825 = (0);
while(true){
if((i__4790__auto___30825 < len__4789__auto___30824)){
args__4795__auto__.push((arguments[i__4790__auto___30825]));

var G__30826 = (i__4790__auto___30825 + (1));
i__4790__auto___30825 = G__30826;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq30775){
var G__30776 = cljs.core.first(seq30775);
var seq30775__$1 = cljs.core.next(seq30775);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30776,seq30775__$1);
}));

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__30830__delegate = function (rdr,_){
...
var G__30830 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__30834__i = 0, G__30834__a = new Array(arguments.length -  1);
while (G__30834__i < G__30834__a.length) {G__30834__a[G__30834__i] = arguments[G__30834__i + 1]; ++G__30834__i;}
  _ = new cljs.core.IndexedSeq(G__30834__a,0,null);
} 
return G__30830__delegate.call(this,rdr,_);};
G__30830.cljs$lang$maxFixedArity = 1;
G__30830.cljs$lang$applyTo = (function (arglist__30835){
var rdr = cljs.core.first(arglist__30835);
var _ = cljs.core.rest(arglist__30835);
return G__30830__delegate(rdr,_);
});
