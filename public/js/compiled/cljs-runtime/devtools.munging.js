...
var o27490 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27490["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27491 = temp__5733__auto____$1;
return (o27491["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26698__auto__ = f;
return (o__26698__auto__["toString"]).call(o__26698__auto__);
} else {
return "";
}
}catch (e27499){var _ = e27499;
return "";
}});
...
try{var o__26698__auto___27760 = t;
(o__26698__auto___27760["cljs$lang$ctorPrWriter"]).call(o__26698__auto___27760,t,writer);
}catch (e27502){var __27761 = e27502;
}
...
var char_code = (function (){var o__26698__auto__ = (new String(char$));
return (o__26698__auto__["charCodeAt"]).call(o__26698__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26698__auto__ = String;
return (o__26698__auto__["fromCharCode"]).call(o__26698__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27523 = num_code;
switch (G__27523) {
case (1):
return (185);
...
var o__26698__auto__ = String;
return (o__26698__auto__["fromCharCode"]).call(o__26698__auto__,superscript_code);
});
/**
...
}catch (e27540){var _e__26733__auto__ = e27540;
return false;
}})())){
...
var vec__27542 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27542,(0),null);
...
var temp__5733__auto____$1 = (o27554["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27555 = temp__5733__auto____$1;
return (o27555["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27562){
var vec__27563 = p__27562;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27563,(0),null);
...
var G__27784 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__27785 = cljs.core.butlast(remaining_tokens);
name_tokens = G__27784;
remaining_tokens = G__27785;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27559){
var G__27560 = cljs.core.first(seq27559);
var seq27559__$1 = cljs.core.next(seq27559);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27560,seq27559__$1);
}));
...
var vec__27573 = cljs.core.split_with((function (p1__27571_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27571_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27573,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27573,(1),null);
...
var vec__27580 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27580,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27580,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27792 = cljs.core.rest(remaining_tokens);
var G__27793 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27792;
name_tokens = G__27793;
continue;
} else {
...
var vec__27587 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27587,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27587,(1),null);
var vec__27590 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27590,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27590,(1),null);
var vec__27593 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27593,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27593,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27593,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27593,(3),null);
...
var vec__27601 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27601,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27601,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27601,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27601,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27601,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27601,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__27611 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27611,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27611,(1),null);
var vec__27614 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27614,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27614,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27621 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27621) : devtools.munging.parse_fn_info_deep.call(null,G__27621));
})()));
}
} else {
return fn_info;
...
var G__27820 = (arity + (1));
var G__27821 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27629){
var vec__27630 = p__27629;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27630,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27630,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27647_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27647_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27648_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27648_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27656){
var vec__27657 = p__27656;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27657,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27652){
var G__27653 = cljs.core.first(seq27652);
var seq27652__$1 = cljs.core.next(seq27652);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27653,seq27652__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27675__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27675__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27675__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27675__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27676 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27676,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27676,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27676,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27676,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27676,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27676,(5),null);
...
var o__26698__auto__ = f;
return (o__26698__auto__["getBasis"]).call(o__26698__auto__);
});
/**
...
}catch (e27697){var _e__26733__auto__ = e27697;
...
var G__27874 = (obj[cljs.core.first(path)]);
var G__27875 = cljs.core.rest(path);
obj = G__27874;
path = G__27875;
continue;
} else {
...
var _STAR_ = (function (accum,p__27711){
var vec__27712 = p__27711;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27712,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27712,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27739){
var vec__27740 = p__27739;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27740,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27740,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27740,(2),null);
...
var post_process = (function (p__27752){
var vec__27753 = p__27752;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27753,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27753,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27747_SHARP_){
return (obj[cljs.core.first(p1__27747_SHARP_)]);
}),sorted_matches);
