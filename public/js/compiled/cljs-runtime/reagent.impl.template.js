...
var G__37623 = o;
(G__37623[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__37797__delegate = function (args){
...
while (G__37798__i < G__37798__a.length) {G__37798__a[G__37798__i] = arguments[G__37798__i + 0]; ++G__37798__i;}
  args = new cljs.core.IndexedSeq(G__37798__a,0,null);
} 
...
var args = cljs.core.seq(arglist__37799);
...
var G__37630 = o;
(G__37630[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__37805__i < G__37805__a.length) {G__37805__a[G__37805__i] = arguments[G__37805__i + 0]; ++G__37805__i;}
  args = new cljs.core.IndexedSeq(G__37805__a,0,null);
} 
return G__37802__delegate.call(this,args);};
G__37802.cljs$lang$maxFixedArity = 0;
G__37802.cljs$lang$applyTo = (function (arglist__37806){
var args = cljs.core.seq(arglist__37806);
...
var G__37653 = props;
var G__37653__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37653,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37653);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37653__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37658){
...
var props = map__37659__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37659__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37669){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37670__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(G__37697["onChange"] = (function (p1__37685_SHARP_){
...
var vec__37703 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37703,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37703,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37703,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___37842 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___37842 == null)){
} else {
var key_37843 = temp__5739__auto___37842;
(jsprops["key"] = key_37843);
}
...
var temp__5739__auto___37845 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___37845 == null)){
} else {
var key_37846 = temp__5739__auto___37845;
reagent.impl.template.oset(jsprops,"key",key_37846);
}
...
var G__37722 = reagent.impl.template.__GT_NativeWrapper();
(G__37722["name"] = c);
...
var G__37733 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__37733) : reagent.impl.template.as_element.call(null,G__37733));
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37744){
var G__37745 = cljs.core.first(seq37744);
var seq37744__$1 = cljs.core.next(seq37744);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37745,seq37744__$1);
}));
...
break;
default:
var G__37901 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__37901;
continue;
...
var n__4666__auto___37905 = a.length;
var i_37907 = (0);
while(true){
if((i_37907 < n__4666__auto___37905)){
(a[i_37907] = reagent.impl.template.as_element((a[i_37907])));

var G__37909 = (i_37907 + (1));
i_37907 = G__37909;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4666__auto___37912 = a.length;
var i_37913 = (0);
while(true){
if((i_37913 < n__4666__auto___37912)){
var val_37915 = (a[i_37913]);
if(((cljs.core.vector_QMARK_(val_37915)) && ((reagent.impl.template.key_from_vec(val_37915) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_37913] = reagent.impl.template.as_element(val_37915));

var G__37916 = (i_37913 + (1));
i_37913 = G__37916;
continue;
} else {
}
...
var ctx = ({});
var vec__37772 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37772,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37772,(1),null);
...
var G__37775 = (cljs.core.count(argv) - first_child);
switch (G__37775) {
case (0):
...
case (1):
var G__37776 = comp;
var G__37777 = jsprops;
var G__37778 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__37776,G__37777,G__37778);
